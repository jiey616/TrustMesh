...
- **前端 (Frontend-v2)**：`trustmesh/frontend-v2:20260917-110837`（commit `9e2a122`：**P0 修复 —— `PATCH /users/me` 响应信封解包**，解决「改名后页面不刷新 + 切换组织失效」；资源哈希 `index-Dz0GZ9ha.js`）。
  - *回滚锚点*：`20260917-081102`（外部应用三级标签页）/ `20260917-072506`（「组织」文案 + 个人信息页收纳）/ `20260916-214416`（平台用户管理 + 全局菜单基线）。
