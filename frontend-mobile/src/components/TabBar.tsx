        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className="relative flex flex-1 flex-col items-center justify-center gap-[3px] py-[7px]"
            ...
            >
              <span className="flex h-[22px] items-center">
                ...
                {tab.key === 'inbox' && showBadge && unread > 0 ? (
                  <span
                    className="ml-[2px] min-w-[16px] rounded-full px-[4px] text-center text-[10px] leading-[16px] text-white"
